...
func New(cfg *Config) (*Server, error) {
	...
	s.router.HandleFunc("/ajax", s.requireLogin(s.ajax))
	...
	s.router.HandleFunc("/accounts/{id:[0-9]+}/advance", s.requireAdmin(s.advanceAccount))
	...
	s.router.HandleFunc("/schedules", s.requireAdmin(s.schedules))
	s.router.HandleFunc("/schedules/new", s.requireAdmin(s.editSchedule))
	s.router.HandleFunc("/schedules/{id:[0-9]+}/edit", s.requireAdmin(s.editSchedule))
	s.router.HandleFunc("/schedules/{id:[0-9]+}/delete", s.requireAdmin(s.deleteSchedule))
